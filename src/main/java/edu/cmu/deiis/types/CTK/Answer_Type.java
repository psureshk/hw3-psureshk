...
public class Answer_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.deiis.types.CTK.Answer");
  ...
  public boolean getIsCorrect(int addr) {
      ...
      jcas.throwFeatMissing("isCorrect", "edu.cmu.deiis.types.CTK.Answer");
